...
PICS = (environ.get('PICS', 'https://graph.org/file/19a0fb7d103b712d7bf98.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1432279675').split()] # For Multiple Id Use One Space Between Each.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://t.me/Adityahelp24_bot') # payment code picture url.
