...
PICS = (environ.get('PICS', 'https://graph.org/file/6fe5bdfe0805d8b91fb4c.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5232142502 , 6991688781').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002292107201').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002004887345') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002466639926')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://King:Cobra765592@cluster0.qy4m5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://t.me/AJ_TVSERIAL_BOT') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/AT_SERIAL')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/AT_SERIAL')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'AT_SERIAL') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/AJ_TVSERIAL_BOT')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'b8b9bceee226aab97568c7163567b6cd31c603bd')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/how_to_downloadvanshaj4')
